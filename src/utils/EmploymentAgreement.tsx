    ...
    <div className="bg-white rounded-lg shadow-sm border border-black-100 p-8">
      ...
      <div className="text-blue-600 leading-relaxed">
        ...
        <p id="employer-name-placeholder">
          ...
          <span className="placeholder-registered-address">
            Registered Address
          </span>
        ...
        <p>
          ...
          residing at{" "}
          <span className="placeholder-employee-address">Employee Address</span>{" "}
          ("Employee").
        </p>
        ...
        <p>
          The Employee’s employment with the Company shall commence on{" "}
          <span className="placeholder-employment-start-date">
            Employment Start Date
          </span>
          . The Employee's period of continuous employment will begin on this
          date.
        </p>
        ...
        <p id="probationary-period-clause">
          (The first {" "}
          <span className="placeholder-probation-period-length">Probation Period Length</span> months of
        ...
        <p id="job-title-and-duties">
          ...
          report to{" "}
          <span className="placeholder-reporting-manager">
            Reporting Manager
          </span>
          . The Employee's primary duties shall include{" "}
          <span className="placeholder-duties">
        ...
        <p>
          ...
          <span className="placeholder-workplace-address">
            Workplace Address
          </span>
          .
        </p>
        ...
        <p>
          ...
          <span className="placeholder-days-of-work">Days of Work</span>. The
          Employee may be required to work additional hours as necessary to
        ...
        <p>
          ...
          <span className="placeholder-annual-salary">Annual Salary</span> USD
          per{" "}
          <span className="placeholder-payment-frequency">
            Payment Frequency
          </span>
          , payable in arrears on or before{" "}
          <span className="placeholder-payment-date">Payment Date</span> by
          direct bank transfer. The Company reserves the right to deduct any
          sums lawfully due, including overpayments or losses caused by the
          Employee’s actions.
        </p>
        ...
        <p>
          ...
          <span className="placeholder-holiday-entitlement">
            Holiday Entitlement
          </span>{" "}
          days of paid annual leave per year, including UK public holidays.
          Unused leave may not be carried forward without prior approval. {"{"}
          Upon termination, unused leave will be paid. For Unused Holiday Days
          unused days, the holiday pay is Holiday Pay USD.{"}"}
        </p>
        ...
        <p>
          ...
          accordance with current legislation. {"{"}The Employee may also be
          entitled to Company sick pay.{"}"}
        </p>

        <h2 className="text-2xl font-bold mt-6">(PENSION</h2>
        <p>
          The Employee will be enrolled in the Company’s workplace pension
          scheme in accordance with the Pensions Act 2008. Contributions will be
          made as required under auto-enrolment legislation.)
        </p>

        <h2 className="text-2xl font-bold mt-6">TERMINATION CLAUSE</h2>
        <p>
          Either party may terminate the employment by providing{" "}
          <span className="placeholder-notice-period">Notice Period</span> weeks
          written notice. The Company reserves the right to make a payment in
          lieu of notice.{" "}
          <span className="text-black font-bold">(Optional Clause)</span>
        </p>
        ...
        <h2 className="text-2xl font-bold mt-6">CONFIDENTIALITY</h2>
        <p>
          The Employee must not, during or after employment, disclose any
          confidential information belonging to the Company or its clients.
        </p>
        ...
        <p>
          ...
          procedures, details of which are available upon request.
        </p>
        ...
        <p>
          Name:{" "}
          <span className="placeholder-authorized-representative">
            Authorized Representative
          </span>
        </p>
        <p>
          Title:{" "}
          <span className="placeholder-representative-title">
            Job Title of the authorized representative
          </span>
        </p>
        <p className="mb-3">
          Date:{" "}
          <span className="placeholder-signature-date">Date of signature</span>
        </p>
        <p className="mb-3">
          <strong>Employee:</strong>
        </p>
        ...
        <p>
          Date:{" "}
          <span className="placeholder-signing-date">
            Date of signing by Employee
          </span>
        </p>
      </div>
    </div>
